...
import { CharacterCard, CharacterSkeletonCard } from "."
import { useLocalStorage } from "../../hooks/useLocalStorage"

export const CharactersList = () => {
    const [inputValue, setInputValue] = useLocalStorage('characters-search', "");
    const { characters, loading, setOffset, total, setSearch } = useFetchCharacters(inputValue)
